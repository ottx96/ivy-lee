...
data class TaskGridCellContainer(var borderPane: BorderPane, var titleLabel: Label,
                                 var descLabel: WebView, var timeLabel: Label, var progressBar: ProgressBar,
                                 var progressBarAdditional: ProgressBar, var statusIndicator: ProgressIndicator): Comparable<TaskGridCellContainer>{
